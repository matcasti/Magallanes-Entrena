...
\hypertarget{metodos}{%
\section{Material y métodos}\label{metodos}}

\hypertarget{sujetos}{%
\subsection{Sujetos}\label{sujetos}}
...
Tabla 2.1. \label{tab:regiones} Proporción de personas por sexo en cada región.
...
& \multicolumn{2}{c}{\textbf{Sexo}} & \\ 
 \cmidrule(lr){2-3}
\textbf{Característica} & Hombre & Mujer & \textbf{Total} \\ 
\midrule
Región &  &  &  \\ 
...
Tabla 2.2. \label{tab:sf36-table} Dominios evaluativos en el cuestionario SF-36.

\begin{tabular}[t]{>{}l>{\raggedright\arraybackslash}p{12cm}}
\toprule
\multicolumn{1}{c}{\textbf{Dimensión}} & \multicolumn{1}{>{\centering\arraybackslash}p{12cm}}{\textbf{Significado}}\\
\midrule
Función física & Grado en el que la falta de salud limita las actividadesfísicas de la vida diaria, como el cuidado personal, caminar, subir escaleras, coger o transportar cargas, y realizar esfuerzos moderados e intensos.\\
...
{\centering \includegraphics[width=1\linewidth]{reportes_files/figure-latex/sexo-vs-actfisc-1} 
...
\subsection{Entrenamiento computarizado}\label{entrenamiento-computarizado}}
...
\subsection{Talleres de nutrición}\label{talleres-de-nutriciuxf3n}}
...
Como unidad de medida de tamaño de efecto (ES) se utilizó la correlación biserial \((\widehat{r})\) de Cohen para las comparaciones de grupos mediante la prueba Wilcoxon-Mann-Whitney; Epsilon\textsuperscript{2} \((\epsilon^2)\) como ES para la prueba Kruskall-Wallis y la \(V\) de Cramer para la prueba de \(\chi{}^2\) de Pearson.

\hypertarget{resultados}{%
\section{Resultados}\label{resultados}}

\hypertarget{actividad-fuxedsica}{%
\subsection{Actividad física}\label{actividad-fuxedsica}}
...
Tabla 3.1. \label{tab:summary-sexo} Valores por variable de estudio para los grupos de cada nivel de la categoría sexo de la submuestra correspondiente a la Región de Magallanes.
...
& & \multicolumn{2}{c}{\textbf{Sexo}} & \\ 
 \cmidrule(lr){3-4}
\textbf{Variables} & \textbf{Total}\textsuperscript{1} & \textbf{Hombre}, N = 34\textsuperscript{1} & \textbf{Mujer}, N = 137\textsuperscript{1} & \textbf{P-valor}\textsuperscript{2} \\ 
\midrule
Edad & 32 ± 9 & 32 ± 10 & 32 ± 9 & 0.986 \\ 
MET's /semana & 1,214 ± 1,562 & 1,508 ± 2,162 & 1,141 ± 1,374 & 0.656 \\ 
Actividad física &  &  &  & 0.502 \\ 
Bajo & 90 (53\%) & 19 (56\%) & 71 (52\%) &  \\ 
Moderado & 43 (25\%) & 6 (18\%) & 37 (27\%) &  \\ 
Alto & 38 (22\%) & 9 (26\%) & 29 (21\%) &  \\ 
Dolor corporal & 27 ± 20 & 19 ± 16 & 29 ± 21 & 0.004 \\ 
Función física & 90 ± 17 & 92 ± 14 & 89 ± 17 & 0.337 \\ 
Función social & 35 ± 24 & 22 ± 20 & 38 ± 24 & <0.001 \\ 
Rol emocional & 80 ± 36 & 73 ± 41 & 82 ± 35 & 0.160 \\ 
Rol físico & 62 ± 43 & 59 ± 45 & 63 ± 43 & 0.570 \\ 
Salud general & 45 ± 13 & 49 ± 11 & 44 ± 14 & 0.042 \\ 
Salud mental & 41 ± 9 & 38 ± 11 & 41 ± 8 & 0.057 \\ 
Vitalidad & 44 ± 10 & 43 ± 11 & 44 ± 10 & 0.816 \\ 
Evolución de salud &  &  &  & 0.698 \\ 
...
SF-36 Score & 53 ± 11 & 49 ± 10 & 54 ± 11 & 0.016 \\ 
\bottomrule
\end{longtable}
\vspace{-5mm}
\begin{minipage}{\linewidth}
\textsuperscript{1}Estadísticos presentados: Media ± DE; n (\%) \\ 
\textsuperscript{2}Tests estadísticos realizados: Prueba de suma de rangos de Wilcoxon; prueba chi cuadrado de independencia; test exacto de Fisher \\ 
\end{minipage}

\hypertarget{salud-seguxfan-sf-36}{%
\subsection{Salud según SF-36}\label{salud-seguxfan-sf-36}}
...
Tabla 3.2. \label{tab:summary-actfisc} Valores por variable de estudio para los grupos de cada nivel de la categoría actividad física de la submuestra correspondiente a la Región de Magallanes.

\captionsetup[table]{labelformat=empty,skip=1pt}
\begin{longtable}{lcccc}
\toprule
& \multicolumn{3}{c}{\textbf{Actividad física}} & \\ 
 \cmidrule(lr){2-4}
\textbf{Variables} & \textbf{Bajo}, N = 90\textsuperscript{1} & \textbf{Moderado}, N = 43\textsuperscript{1} & \textbf{Alto}, N = 38\textsuperscript{1} & \textbf{P-valor}\textsuperscript{2} \\ 
\midrule
Edad & 32 ± 9 & 31 ± 9 & 33 ± 9 & 0.648 \\ 
Sexo &  &  &  & 0.502 \\ 
Hombre & 19/90 (21\%) & 6/43 (14\%) & 9/38 (24\%) &  \\ 
Mujer & 71/90 (79\%) & 37/43 (86\%) & 29/38 (76\%) &  \\ 
MET's /semana & 278 ± 341 & 1,196 ± 460 & 3,451 ± 1,848 & <0.001 \\ 
Dolor corporal & 29 ± 18 & 27 ± 22 & 25 ± 23 & 0.363 \\ 
Función física & 90 ± 14 & 92 ± 14 & 87 ± 24 & 0.059 \\ 
Función social & 35 ± 24 & 36 ± 25 & 35 ± 24 & 0.963 \\ 
Rol emocional & 83 ± 34 & 84 ± 33 & 68 ± 42 & 0.087 \\ 
Rol físico & 61 ± 44 & 69 ± 43 & 59 ± 41 & 0.468 \\ 
Salud general & 44 ± 12 & 46 ± 14 & 47 ± 14 & 0.146 \\ 
Salud mental & 41 ± 10 & 39 ± 7 & 42 ± 9 & 0.135 \\ 
Vitalidad & 44 ± 11 & 43 ± 9 & 46 ± 9 & 0.388 \\ 
Evolución de salud &  &  &  &  \\ 
...
SF-36 Score & 53 ± 10 & 54 ± 10 & 51 ± 13 & 0.667 \\ 
\bottomrule
\end{longtable}
\vspace{-5mm}
\begin{minipage}{\linewidth}
\textsuperscript{1}Estadísticos presentados: Media ± DE; n/N (\%) \\ 
\textsuperscript{2}Tests estadísticos realizados: Prueba de Kruskall-Wallis; prueba chi cuadrado de independencia \\ 
\end{minipage}
